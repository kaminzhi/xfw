...
pub struct Clipboard {
    ...
    current_offer: Option<Proxy<wl_data_offer::WlDataOffer>>,
...
pub struct DataDeviceHandler {
    ...
    seat: Option<Proxy<wl_seat::WlSeat>>,
}
...
impl DataDeviceHandler {
    ...
    pub fn set_seat(&self, seat: Proxy<wl_seat::WlSeat>) {
        self.seat.replace(seat);
    }
